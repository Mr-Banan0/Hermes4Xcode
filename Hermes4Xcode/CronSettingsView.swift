    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("Name").font(.system(size: 10, design: .monospaced)).foregroundColor(.secondary)
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("Schedule").font(.system(size: 10, design: .monospaced)).foregroundColor(.secondary)
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("Prompt").font(.system(size: 10, design: .monospaced)).foregroundColor(.secondary)
